 ...
 */
#ifndef FRAMETYPE_TAG_H
#define FRAMETYPE_TAG_H
...
public:
   ...
   */
  FrameTypeTag (uint32_t frametype);
   ...
   * \return type ID
   */
  uint32_t GetFrameType (void) const;

private:
  uint32_t m_frametype;  //!< Traffic ID
};

} // namespace ns3

#endif /* FRAMETYPE_TAG_H */
